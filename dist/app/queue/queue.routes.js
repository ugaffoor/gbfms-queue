  ...
  function routes($stateProvider) {
    ...
    $stateProvider.state('queue', {
      ...
      resolve: {
        ...
        cancelledStatuses: ["currentSpace", "currentKapp", "$q", function(currentSpace, currentKapp, $q) {
    ...
    $stateProvider.state('queue.by.details.summary', {
      ...
      views: {
        '': {
          ...
          resolve: {
            subtasks: ["currentUser", "item", "filterName", "forms", "$q", function(currentUser, item, filterName, forms, $q) {
    ...
    $stateProvider.state('queue.create.team', {
      ...
      views: {
        '': {
          ...
          resolve: {
            activeTeam: ["$stateParams", function($stateParams) {
              return $stateParams.activeTeam;
            }],
            formsByTeam: ["activeTeam", "forms", function(activeTeam, forms) {

(function() {
  ...
  function routes($stateProvider) {
    $stateProvider.state('queue', {
      ...
      resolve: {
        configResolver: ["currentUser", "currentKapp", "$state", function(currentUser, currentKapp, $state) {
        ...
        filters: ["currentKapp", function(currentKapp) {
          // Fetch the attribute
